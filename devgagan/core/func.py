...
async def subscribe(app, message):
   ...
   if update_channel:
      try:
        ...
        await message.reply_photo(photo="https://i.postimg.cc/TwBsgbGG/image.png",caption=caption, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Join Now...", url=f"{url}")]]))
        return 1
      except Exception:
